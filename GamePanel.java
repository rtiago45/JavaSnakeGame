...
public class GamePanel extends JPanel implements ActionListener {
	...
	public void checkCollisions() {
		...
		// verifica se a cabeça colide com a borda esquerda
		if(x[0] < 0) {
			running = false;
		}
		// verifica se a cabeça colide com a borda direita
		if(x[0] > SCREEN_WIDTH) {
			running = false;
		}
		// verifica se a cabeça colide com a parte de cima
		if(y[0] < 0) {
			running = false;
		}
		// verifica se a cabeça colide com a parte de baixo
		if(y[0] > SCREEN_WIDTH) {
			running = false;
		}
		if(!running) {
